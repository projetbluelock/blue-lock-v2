...
const sessionCatalog = {
  ...
  dev_vitesse_sprint: {
    ...
    image: "schemes/intensif_sprints.png"
  },
  dev_technique_vitesse: {
    ...
    image: "schemes/intensif_conduite_frappe.png"
  },
  dev_pliometrie: {
    ...
    image: "schemes/intensif_pliometrie.png"
  },
  dev_duel_defensif: {
...
const phasePrograms = {
  ...
  specialisation: {
    1: [
      ...
      { jour: "Mercredi", key: "dev_fractionne" },
      { jour: "Jeudi",    key: "spe_duel_defensif" || "dev_duel_defensif" },
...
function renderWeek(phaseKey, weekNumber) {
  ...
  weekPlan.forEach((session, index) => {
    ...
    const imageHtml = image
      ? `<div class="session-image"><img src="${image}" alt="Schéma ${title}" loading="lazy"></div>`
      : "";
